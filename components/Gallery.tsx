...
export const Gallery: React.FC = () => {
    ...
    return (
        <section id="Gallery" className="pt-8 pb-16 sm:pt-12 sm:pb-20 md:py-24 bg-navy-950 text-white relative border-t border-white/5 overflow-hidden scroll-mt-20 md:scroll-mt-24">
