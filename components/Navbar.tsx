        ...
        <>
            ...
            >
                <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center gap-6">
                    ...
                    >
                        <img src="assets/logo.png" alt="NeoLiv" width={120} height={34} className="h-8 md:h-9 w-auto shrink-0 transition-transform group-hover:scale-105 duration-300" />
                        <div className="w-px h-5 md:h-6 bg-gold-400/30 shrink-0" />
                        <span className="font-serif text-[10px] md:text-xs tracking-[0.22em] text-white/90 uppercase font-medium leading-none whitespace-nowrap shrink-0">
            ...
            >
                ...
                <div className="relative z-10 flex justify-between items-center px-6 py-5 border-b border-white/10 shrink-0 bg-navy-950/40 backdrop-blur-md">
                    <div className="flex items-center gap-3 shrink-0">
                        <img src="assets/logo.png" alt="NeoLiv" width={110} height={30} className="h-7 sm:h-8 w-auto shrink-0" />
                        <div className="w-px h-4 sm:h-5 bg-gold-400/30 shrink-0" />
                        <span className="font-serif text-[10px] tracking-[0.2em] text-white/90 uppercase font-medium whitespace-nowrap leading-none">
                            GRAND FOREST <span className="text-gold-400 font-semibold">PRIVÉ</span>
                        </span>
                    </div>
                    <button 
                ...
                <div className="relative z-10 px-6 pt-4 pb-7 border-t border-white/10 text-center shrink-0 bg-navy-950/80 backdrop-blur-md">
                    <p className="text-[10px] tracking-[0.25em] text-gold-400/90 font-sans font-semibold uppercase mb-3">
